...
public class OTPNumberInputTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otpnumber_input_teachers);
        ...
        sendOTPButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(OTPNumberInputTeacher.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED) {
                    generateAndSendOTP(phoneNumber);
                } else {
                    // Request permission to send SMS
                    ActivityCompat.requestPermissions(OTPNumberInputTeacher.this, new String[]{Manifest.permission.SEND_SMS}, SMS_PERMISSION_CODE);
                }
            }
        });
    }
    ...
    private void generateAndSendOTP(String phoneNumber) {
        ...
        saveTeacherToFirebase(phoneNumber, otp);
        ...
        try {
            ...
            // Navigate to OTPReceiveTeacher activity
            Intent intent = new Intent(OTPNumberInputTeacher.this, SignUpTeacher.class);
    ...
    private void saveTeacherToFirebase(String phoneNumber, String otp) {
        // Create a unique key for the teacher using their phone number
        String userId = phoneNumber; // Phone number acts as the unique ID

        // Create a TeacherUserModel object
        ...
        // Save the teacher data to Firebase under the "teachers" node
        teachersRef.child(userId).setValue(teacher)
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        Toast.makeText(this, "Teacher data saved to Firebase", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(this, "Failed to save teacher data: " + task.getException(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}