...
public class StudentAssignmentsActivity extends AppCompatActivity {
    ...
    private List<QuestionSetModel> assignedSets = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new QuestionSetAdapter(assignedSets, StudentAssignmentsActivity.this, studentUid);
    ...
    private void loadAssignedQuestionSets() {
        assignmentsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                for (DataSnapshot child : assignmentSnapshot.getChildren()) {
                    ...
                    questionSetsRef.child(setId).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(StudentAssignmentsActivity.this, "Failed to fetch set: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StudentAssignmentsActivity.this, "Failed to fetch assignments", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
